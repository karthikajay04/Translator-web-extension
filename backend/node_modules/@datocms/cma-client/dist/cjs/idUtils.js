...
exports.generateId = exports.isValidId = void 0;
var uuid_1 = require("uuid");
function fromUint8ArrayToUrlSafeBase64(bytes) {
    var base64 = typeof Buffer === 'undefined'
        ? btoa(Array.from(bytes, function (byte) { return String.fromCharCode(byte); }).join(''))
...
function generateId() {
    var bytes = (0, uuid_1.v4)(null, new Uint8Array(16));
    ...
    var base64 = fromUint8ArrayToUrlSafeBase64(bytes);
    return base64;
}
