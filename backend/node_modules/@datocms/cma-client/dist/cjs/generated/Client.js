...
var Client = /** @class */ (function () {
    ...
    Client.prototype.request = function (options) {
        var _this = this;
        return (0, rest_client_utils_1.request)(__assign(__assign(__assign({}, this.config), options), { logFn: this.config.logFn || console.log, userAgent: '@datocms/cma-client v4.0.2', baseUrl: this.baseUrl, preCallStack: new Error().stack, extraHeaders: __assign(__assign(__assign({}, (this.config.extraHeaders || {})), (this.config.environment
                ? { 'X-Environment': this.config.environment }
                : {})), { 'X-API-Version': '3' }), fetchJobResult: function (jobId) {
                return _this.jobResultsFetcher
                    ? _this.jobResultsFetcher(jobId)
                    : (0, rest_client_utils_1.pollJobResult)(function () { return _this.jobResults.find(jobId); });
            } }));
    };
