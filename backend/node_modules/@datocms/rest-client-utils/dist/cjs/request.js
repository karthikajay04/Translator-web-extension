...
exports.request = exports.getFetchFn = exports.LogLevel = void 0;
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    ...
                    requestCount += 1;
                    fetchFn = getFetchFn(options.fetchFn);
                    ...
                    headers = __assign({ 'content-type': 'application/json', accept: 'application/json', authorization: "Bearer ".concat(options.apiToken), 'user-agent': userAgent }, (options.extraHeaders ? lowercaseKeys(options.extraHeaders) : {}));
                    if (isBrowser) {
