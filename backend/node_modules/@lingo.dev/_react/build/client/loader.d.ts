 ...
 * ```
 */
export declare const loadDictionary: (locale: string | null) => Promise<any>;
export declare const loadDictionary_internal: (locale: string | null, dictionaryLoaders?: Record<string, () => Promise<any>>) => Promise<any>;
