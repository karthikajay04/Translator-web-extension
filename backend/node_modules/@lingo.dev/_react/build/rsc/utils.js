...
import { LOCALE_HEADER_NAME, LOCALE_COOKIE_NAME } from "../core/index.js";
...
export async function setLocaleInCookies(locale) {
  const requestCookies = await cookies();
  requestCookies.set(LOCALE_COOKIE_NAME, locale);
}
export async function loadDictionaryFromRequest(loader) {
