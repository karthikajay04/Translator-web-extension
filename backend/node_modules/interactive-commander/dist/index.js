...
var InteractiveOption = class extends Option {
...
// src/interactive-command.ts
var InteractiveCommand = class _InteractiveCommand extends Command {
  ...
  async parseAsync(argv, options) {
    ...
    try {
      const { providedOptions, missingOptions, providedOptionsSources } = partialParse(this, argv ?? process.argv, options);
      ...
      if (!(error instanceof CommanderError || // This is needed for the minified version
